...
pub fn chinese_remainder_theorem(inp : Vec<(i128,i128)>) -> (i128,i128) {
    ...
    for (n_1,a_1) in iter {
        ...
        // Clamp solution to be minimum positive option
        if solution < 0 {
...
#[cfg(test)]
mod tests {
    use crate::aoc::math::{extended_gcd, chinese_remainder_theorem};
    ...
    fn test_chinese_remainder() {
        ...
        assert_eq!( chinese_remainder_theorem(vec![(3,0),(4,3),(5,4)]), (60,39) );
    }
}